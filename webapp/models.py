...
class Employee(Model, models.Model):
    ...
    introduction_1 = models.CharField('社歴',max_length=255,default='')
    introduction_2 = models.CharField('アピール',max_length=255,default='')
    introduction_3 = models.CharField('紹介',max_length=255,default='')
